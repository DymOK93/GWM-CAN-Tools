...
#
#
def rebootHud(uds_mode: str, windll: str) -> None:
    print(f'Reboot HUD')
    with uds.Hud(uds.getModeValue(uds_mode), 
                    lambda txid, rxid: J2534Connection(windll, rxid, txid)) as hud:
        hud.callSafe(lambda: hud.resetHard())

#
# Does processing
#
def main():
    print('HUD reboot using J2534 compatible scanner')
    ...
    rebootHud(args.uds_mode, args.windll)
